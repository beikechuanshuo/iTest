...
@implementation HRecordVideoEncoder
...
{
    HRecordVideoEncoder* enc = [HRecordVideoEncoder alloc];
...
- (void)initVideoInputHeight:(NSInteger)cy width:(NSInteger)cx
{
    ...
    NSDictionary* settings = [NSDictionary dictionaryWithObjectsAndKeys:
                              ...
                              @{AVVideoAverageBitRateKey:@(bitRate),
                                  ...
                                  AVVideoProfileLevelKey : AVVideoProfileLevelH264BaselineAutoLevel},AVVideoCompressionPropertiesKey,AVVideoScalingModeResizeAspectFill,AVVideoScalingModeKey,
                              nil];
    //初始化视频写入类
