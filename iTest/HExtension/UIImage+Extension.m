...
+ (UIImage *)blurImageFromImage:(UIImage *)image
{
    ...
    CGImageRef outImage = [ciContext createCGImage: result fromRect:[result extent]];
...
+ (UIImage *)imageWithScreenWindow
{
    ...
    [[[UIApplication sharedApplication].windows objectAtIndex:0].layer renderInContext:UIGraphicsGetCurrentContext()];
