...
#import "QIYIGIFImageView.h"
#import "QIYIGifImage.h"

@interface QIYIGIFImageView ()
{
    int tmp;
}
@property (nonatomic) NSUInteger currentFrameIndex;
@property (nonatomic,strong) QIYIGifImage *animatedImage;
...
@implementation QIYIGIFImageView
...
-(void)setImage:(UIImage *)image
{
    ...
    self.accumulator = 0;
    if ([image isKindOfClass:[QIYIGifImage class]] && image.images)
    {
        //设置静止态的图片
        if (image.images[0])
        {
        ...
        self.animatedImage = (QIYIGifImage *)image;
...
-(void)setAnimatedImage:(QIYIGifImage *)animatedImage
{
